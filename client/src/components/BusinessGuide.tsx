...
const BusinessGuide: React.FC<BusinessGuideProps> = ({ quizData }) => {
  ...
  const { data: businessResources, isLoading: resourcesLoading } = useQuery({
    ...
    queryFn: () => fetch(`/api/business-resources/${businessId}`).then(res => res.json()),
    enabled: !!businessId,
  ...
  const getSkillDescriptions = () => {
    const skillDescriptions: Record<string, Record<string, string>> = {
      'affiliate-marketing': {
        'Understanding of digital marketing basics': 'Learn how online marketing works, including concepts like SEO, social media marketing, email marketing, and paid advertising. Understand customer funnels, conversion rates, and how to track marketing performance.',
        'Ability to create content (blog, video, social)': 'Develop skills in creating engaging content across different platforms. This includes writing compelling blog posts, creating informative videos, and designing social media content that resonates with your target audience.',
        'Patience for long-term results': 'Affiliate marketing typically takes 3-6 months to see significant results. You need mental resilience to stay consistent with content creation and promotion even when immediate results aren\'t visible.',
        'Basic website or social media presence': 'Having a platform where you can share affiliate links and build an audience. This could be a WordPress blog, YouTube channel, Instagram account, or TikTok profile where you can consistently publish content.'
      },
      'freelancing': {
        'Marketable skill (writing, design, development, etc.)': 'A specific skill that businesses need and are willing to pay for. This could be graphic design, web development, copywriting, digital marketing, or any specialized service where you can deliver measurable value.',
        'Portfolio of previous work or sample projects': 'Examples of your work that demonstrate your capabilities. If you don\'t have client work yet, create sample projects that showcase your skills and the quality of work clients can expect.',
        'Professional communication skills': 'Ability to communicate clearly and professionally with clients through emails, video calls, and project management tools. This includes setting expectations, providing updates, and handling feedback constructively.',
        'Time management and self-discipline': 'Skills to manage multiple projects, meet deadlines, and work independently without direct supervision. This includes creating schedules, prioritizing tasks, and maintaining productivity while working from home.'
      },
      'content-creation-ugc': {
        'Smartphone with good camera quality': 'A modern smartphone with at least 1080p video recording capability and good low-light performance. Most content today is shot on phones, so camera quality directly impacts your content\'s professional appearance.',
        'Basic understanding of social media platforms': 'Knowledge of how different platforms work, their algorithms, best posting times, and what type of content performs well on each. Understanding platform-specific features like Instagram Stories, TikTok effects, or YouTube Shorts.',
        'Willingness to be on camera': 'Comfort with appearing in videos and photos, speaking naturally on camera, and developing your on-screen personality. This includes overcoming camera shyness and developing authentic presentation skills.',
        'Creative mindset and storytelling ability': 'Skills in crafting engaging narratives, coming up with creative concepts, and presenting information in entertaining ways. This includes understanding what makes content shareable and how to hook viewers\' attention.'
      }
    };
    
    return skillDescriptions[businessId] || {};
  };
          ...
          phases: [
            {
              ...
              description: 'Establish your brand identity and create initial content',
              duration: '2 weeks',
              goals: ['Choose niche', 'Set up profiles', 'Create initial content'],
              steps: [
                {
                  title: 'Niche Research & Selection',
                  description: 'Research successful creators in potential niches, analyze engagement rates, and choose a specific focus that aligns with your interests and has proven demand.',
                  tasks: ['Study top 10 creators in 3 potential niches', 'Analyze their content patterns', 'Choose your primary niche'],
                  timeframe: 'Days 1-2'
                },
                {
                  title: 'Brand Setup & Profile Optimization',
                  description: 'Create consistent branding across platforms with professional profile photos, compelling bios, and clear value propositions.',
                  tasks: ['Design logo/profile image', 'Write compelling bio', 'Set up Instagram and TikTok profiles'],
                  timeframe: 'Days 3-4'
                },
                {
                  title: 'Content Creation & Initial Posts',
                  description: 'Create your first batch of content following proven formats and post consistently to start building audience.',
                  tasks: ['Create 5 pieces of content', 'Schedule posts', 'Engage with 20 accounts daily'],
                  timeframe: 'Days 5-14'
                }
              ]
            },
            {
              ...
              description: 'Scale content production and build engaged audience',
              duration: '4 weeks',
              goals: ['Consistent posting', 'Audience growth', 'Collaboration start'],
              steps: [
                {
                  title: 'Content Schedule Implementation',
                  description: 'Establish a sustainable posting schedule and create content batches to maintain consistency.',
                  tasks: ['Create 7-day content calendar', 'Batch create weekly content', 'Set up posting schedule'],
                  timeframe: 'Week 3'
                },
                {
                  title: 'Audience Engagement & Community Building',
                  description: 'Actively engage with your audience and other creators to build meaningful connections and increase visibility.',
                  tasks: ['Reply to all comments', 'Engage with 50+ accounts daily', 'Join relevant conversations'],
                  timeframe: 'Week 4-5'
                },
                {
                  title: 'Collaboration & Viral Content',
                  description: 'Partner with other creators and focus on creating content with viral potential.',
                  tasks: ['Reach out to 5 creators for collaboration', 'Create trend-based content', 'Analyze top-performing posts'],
                  timeframe: 'Week 6'
                }
              ]
            },
            {
              ...
              duration: '6 weeks',
              goals: ['Brand partnerships', 'Product launches', 'Revenue generation'],
              steps: [
                {
                  title: 'Brand Partnership Outreach',
                  description: 'Identify and reach out to brands that align with your audience and content style.',
                  tasks: ['Create media kit', 'Research 20 potential brand partners', 'Send partnership proposals'],
                  timeframe: 'Week 7-8'
                },
                {
                  title: 'Product Development & Launch',
                  description: 'Create your own products or services to sell to your audience.',
                  tasks: ['Survey audience needs', 'Create digital product', 'Launch with promotional campaign'],
                  timeframe: 'Week 9-10'
                },
                {
                  title: 'Revenue Optimization',
                  description: 'Optimize your monetization strategy and scale successful revenue streams.',
                  tasks: ['Track revenue metrics', 'Optimize conversion rates', 'Scale successful campaigns'],
          ...
          phases: [
            {
              ...
              duration: '2 weeks',
              goals: ['Profile optimization', 'Portfolio creation', 'First proposals'],
              steps: [
                {
                  title: 'Platform Registration & Profile Setup',
                  description: 'Create compelling profiles on freelance platforms with professional photos, detailed descriptions, and skill showcases.',
                  tasks: ['Create Upwork and Fiverr profiles', 'Write compelling bio', 'Add professional headshot'],
                  timeframe: 'Days 1-2'
                },
                {
                  title: 'Portfolio Development',
                  description: 'Build a strong portfolio showcasing your best work or create sample projects if you\'re just starting.',
                  tasks: ['Create 3-5 sample projects', 'Write case studies', 'Upload to portfolio'],
                  timeframe: 'Days 3-5'
                },
                {
                  title: 'Initial Proposal Strategy',
                  description: 'Research potential clients and submit high-quality proposals to relevant job postings.',
                  tasks: ['Research 20 job postings', 'Write custom proposals', 'Submit 10-15 applications'],
                  timeframe: 'Days 6-14'
                }
              ]
            },
              ...
              steps: [
                {
                  ...
                  description: 'Focus on delivering exceptional work for your first client to build a strong foundation.',
                  tasks: ['Deliver high-quality work', 'Communicate proactively', 'Exceed expectations'],
                  timeframe: 'Week 3'
                },
                {
                  title: 'Review & Testimonial Building',
                  description: 'Secure positive reviews and testimonials to build credibility on platforms.',
                  tasks: ['Request reviews from clients', 'Follow up professionally', 'Showcase testimonials'],
                  timeframe: 'Week 4'
                },
                {
                  title: 'Rate Optimization & Service Expansion',
                  description: 'Gradually increase rates and expand service offerings based on market feedback.',
                  tasks: ['Analyze competitor rates', 'Increase rates by 20%', 'Add new service offerings'],
                  timeframe: 'Week 5-6'
                }
              ]
            },
              ...
              steps: [
                {
                  ...
                  description: 'Focus on retaining existing clients and expanding project scope.',
                  tasks: ['Propose additional services', 'Create retainer agreements', 'Upsell existing clients'],
                  timeframe: 'Week 7-8'
                },
                {
                  title: 'Business Systems Development',
                  description: 'Create systems and processes to handle multiple clients efficiently.',
                  tasks: ['Set up project management system', 'Create client onboarding process', 'Automate invoicing'],
                  timeframe: 'Week 9-10'
                },
                {
                  title: 'Premium Service Launch',
                  description: 'Launch higher-value services and target premium clients.',
                  tasks: ['Develop premium service packages', 'Target enterprise clients', 'Position as expert'],
                  timeframe: 'Week 11-12'
                }
              ]
            }
        ...
        return {
          ...
          phases: [
              ...
              steps: [
                {
                  ...
                  description: 'Create a professional website or blog that serves as your primary platform for affiliate marketing.',
                  tasks: ['Set up WordPress hosting', 'Choose and customize theme', 'Create essential pages'],
                  timeframe: 'Days 1-3'
                },
                {
                  title: 'Niche Research & Program Selection',
                  description: 'Research profitable niches and select affiliate programs that align with your audience and interests.',
                  tasks: ['Analyze 5 potential niches', 'Research competitor strategies', 'Apply to 3-5 affiliate programs'],
                  timeframe: 'Days 4-7'
                },
                {
                  title: 'Content Strategy Development',
                  description: 'Create a content calendar and produce initial high-quality content to attract your target audience.',
                  tasks: ['Create 30-day content calendar', 'Write 3 in-depth blog posts', 'Set up email capture system'],
                  timeframe: 'Week 2-3'
                }
              ]
            },
            {
              ...
              description: 'Scale content production and optimize for search engines',
              duration: '5 weeks',
              goals: ['SEO optimization', 'Content scaling', 'Traffic growth'],
              steps: [
                {
                  title: 'SEO Optimization & Keyword Research',
                  description: 'Optimize existing content and develop SEO strategy for long-term organic traffic growth.',
                  tasks: ['Keyword research for 20 articles', 'Optimize existing posts', 'Build internal linking structure'],
                  timeframe: 'Week 4-5'
                },
                {
                  title: 'Content Production Scaling',
                  description: 'Increase content output while maintaining quality and focusing on affiliate product integration.',
                  tasks: ['Publish 2-3 articles per week', 'Create product comparison posts', 'Develop review templates'],
                  timeframe: 'Week 6-7'
                },
                {
                  title: 'Traffic Diversification',
                  description: 'Expand beyond SEO to include social media, email marketing, and other traffic sources.',
                  tasks: ['Launch social media strategy', 'Create lead magnets', 'Build email sequences'],
                  timeframe: 'Week 8'
                }
              ]
            },
            {
              ...
              description: 'Optimize conversions and scale profitable campaigns',
              duration: '8 weeks',
              goals: ['Conversion optimization', 'Revenue scaling', 'Advanced strategies'],
              steps: [
                {
                  title: 'Conversion Rate Optimization',
                  description: 'Analyze performance data and optimize content and funnels for higher conversion rates.',
                  tasks: ['A/B test call-to-action buttons', 'Optimize product placement', 'Improve page load speeds'],
                  timeframe: 'Week 9-10'
                },
                {
                  title: 'Advanced Monetization Strategies',
                  description: 'Implement advanced techniques like email marketing funnels and retargeting campaigns.',
                  tasks: ['Create email marketing sequences', 'Set up retargeting pixels', 'Launch paid advertising'],
                  timeframe: 'Week 11-13'
                },
                {
                  title: 'Scaling & Automation',
                  description: 'Scale successful campaigns and automate processes for sustainable growth.',
                  tasks: ['Outsource content creation', 'Set up automation tools', 'Expand to new programs'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-12">
            ...
            <section id="prerequisites" className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 mb-6">
                  Click on each skill to learn more about what it involves and how to develop it.
                </p>
                    ...
                    return (
                      <div key={index} className="border border-gray-200 rounded-xl overflow-hidden">
                        <div 
                          ...
                          onClick={() => hasDescription && toggleSkillExpansion(prereq)}
                        >
                          <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <span className="text-gray-900 font-medium">{prereq}</span>
                              {hasDescription && (
                                <motion.div
            ...
            <section id="implementation" className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <div className="flex items-center mb-6">
              ...
              <p className="text-gray-600 mb-8">
                Follow this structured approach to build your business step by step. Each phase includes detailed steps with expandable information.
              </p>
              ...
              <div className="space-y-6">
                {guideContent.phases?.map((phase, phaseIndex) => (
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center mr-4 ${
                            phaseIndex === 0 ? 'bg-blue-600 text-white' :
                            phaseIndex === 1 ? 'bg-green-600 text-white' :
                        ...
                        <div className="text-right">
                          <div className="text-sm font-medium text-gray-700">{phase.duration}</div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {phase.goals?.map((goal, goalIndex) => (
                          <span key={goalIndex} className="px-3 py-1 bg-white text-blue-700 rounded-full text-sm font-medium">
                            {goal}
                          </span>
                        ))}
                      </div>
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-gray-600 text-sm">{step.timeframe}</p>
                                  </div>
                                </div>
                                <motion.div
                                  animate={{ rotate: isExpanded ? 180 : 0 }}
                                      ...
                                      {step.tasks?.map((task, taskIndex) => (
                                        <div key={taskIndex} className="flex items-start">
                                          ...
                                          <span className={`text-sm text-gray-700 ${
                                            completedSteps.has(`${stepKey}-${taskIndex}`) ? 'line-through text-gray-500' : ''
                                          }`}>
                                            {task}
                                          </span>
                                        </div>
                  ...
                  <div className="text-center py-8 text-gray-500">
                    Detailed implementation phases coming soon for this business model.
                  </div>
                )}
              </div>
            </section>
            ...
            <section id="tools-setup" className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              ...
              <div className="mb-6">
                <p className="text-gray-600 text-lg">
                  These are the core tools you'll need to get started. Each tool includes direct links to get you set up quickly.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {businessResources?.tools?.map((tool, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-semibold text-gray-900 group-hover:text-blue-700">{tool.name}</h3>
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        tool.type === 'free' ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'
                      }`}>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-700">
                        {tool.type === 'free' ? 'Free to start' : 'Paid service'}
                      </span>
                ...
                {business.tools?.map((toolName: string, index: number) => {
                  ...
                  const toolUrl = toolUrls[toolName] || `https://www.google.com/search?q=${encodeURIComponent(toolName)}`;
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <h3 className="font-semibold text-gray-900 group-hover:text-purple-700">{toolName}</h3>
                        <span className="px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                          Recommended
                        </span>
                      </div>
                      <p className="text-gray-600 text-sm mb-2">Essential tool for {business.name || 'your business'}</p>
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-700">Click to explore</span>
              ...
              <div className="mt-8 p-6 bg-yellow-50 border border-yellow-200 rounded-xl">
                ...
                <p className="text-yellow-800">
                  Start with the free tools first. You can always upgrade to paid versions as your business grows and generates revenue.
                </p>
              </div>
            </section>
            ...
            {/* Growth & Optimization */}
            <section id="growth-strategy" className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <div className="flex items-center mb-6">
                <TrendingUp className="h-6 w-6 text-purple-600 mr-3" />
                <h2 className="text-2xl font-bold text-gray-900">Growth & Optimization</h2>
              </div>
              
              <p className="text-gray-600 mb-8">
                Once you've completed the implementation phases, focus on these growth strategies to scale your business sustainably.
              </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 border border-green-200 rounded-xl">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900">Audience Expansion</h3>
                    </div>
                    <ul className="space-y-2 text-sm text-gray-700">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 border border-orange-200 rounded-xl">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-gray-900">Revenue Diversification</h3>
                    </div>
                    <ul className="space-y-2 text-sm text-gray-700">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-xl">
                <h3 className="font-semibold text-purple-900 mb-4">Key Performance Indicators</h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-700">20hrs</div>
            ...
            <section id="resources" className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              ...
              <div className="mb-6">
                <p className="text-gray-600 text-lg">
                  Get started faster with these curated resources, templates, and tools specifically selected for {business.name || 'your business model'}. 
                  All links are verified and lead to authentic, high-quality resources.
                </p>
              </div>
              ...
              {resourcesLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {businessResources?.freeResources?.map((resource: ResourceLink, index: number) => (
                        <a
                          key={index}
                          href={resource.url}
                          target="_blank"
                      ...
                      {businessResources?.templates?.map((resource: ResourceLink, index: number) => (
                        <a
                          key={`template-${index}`}
                          href={resource.url}
                          target="_blank"
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {businessResources?.learningResources?.map((resource: ResourceLink, index: number) => (
                        <a
                          key={index}
                          href={resource.url}
                          target="_blank"
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {businessResources?.tools?.map((resource: ResourceLink, index: number) => (
                        <a
                          key={index}
                          href={resource.url}
                          target="_blank"
                  ...
                  {business.resources && Array.isArray(business.resources) && business.resources.length > 0 && (
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
