      ...
      <div className="min-h-screen p-4 bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Personalized recommendations based on your unique goals, skills, and preferences
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <Download className={`h-8 w-8 mx-auto mb-4 group-hover:scale-110 transition-transform ${
            ...
            >
              ...
              <Share2 className={`h-8 w-8 mx-auto mb-4 group-hover:scale-110 transition-transform ${
          ...
          >
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <motion.p
                ...
                animate="animate"
              >
                Access your personalized dashboard to track your progress, view detailed insights, and manage your business journey.
              </motion.p>
