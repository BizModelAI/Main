    ...
    const loadBusinessModelScores = async () => {
      ...
      try {
        ...
        if (quizData) {
          ...
          const formattedBusinessModels = calculatedMatches.slice(0, 9).map((match) => {
            ...
            const businessModelMap: Record<string, any> = {
              ...
              'saas-development': {
                ...
                description: "Build and launch software applications or SaaS products",
              ...
              'social-media-agency': {
                ...
                description: "Manage social media accounts and marketing for businesses",
                timeToProfit: "2-6 months",
