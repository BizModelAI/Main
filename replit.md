...
- July 11, 2025. Fixed AI loading flow to ensure all OpenAI API calls complete during loading page before showing results. Loading page now generates all AI content (insights, analysis, characteristics, descriptions) and enforces minimum 10-second loading time. Results page receives pre-generated data but maintains backward compatibility by generating content if not preloaded.
