...
export async function generateBusinessResources(businessModel: string): Promise<BusinessResources> {
...
function getFallbackResources(businessModel: string): BusinessResources {
    ...
    freeResources: [
      {
        ...
        description: "Comprehensive business plan guide from the Small Business Administration",
        type: "free" as const
      },
      {
        name: "SCORE Business Mentoring",
        url: "https://www.score.org/",
        description: "Free business mentoring and resources from experienced entrepreneurs",
        type: "free" as const
      },
      {
    ...
    learningResources: [
      {
        ...
        description: "Free courses on Google Ads, Analytics, and digital marketing",
        type: "free" as const
      },
      {
      ...
      },
      {
        ...
        description: "Business courses from Harvard, MIT, and other top universities",
        type: "free" as const
      }
    ],
    tools: [
      {
        ...
        description: "Design tool for creating marketing materials and graphics",
        type: "free" as const
      },
      {
        name: "Google Workspace",
        url: "https://workspace.google.com/",
        description: "Business productivity suite with email, docs, and collaboration tools",
        type: "paid" as const
      },
      {
        name: "Mailchimp",
      ...
      },
      {
        ...
        description: "Project management tool for organizing tasks and workflows",
        type: "free" as const
      }
    ],
    templates: [
  ...
  return {
    freeResources: [...baseResources.freeResources, ...specificResources.freeResources],
    learningResources: [...baseResources.learningResources, ...specificResources.learningResources],
    tools: [...baseResources.tools, ...specificResources.tools],
    templates: [...baseResources.templates, ...specificResources.templates]
  };
}

function getBusinessModelSpecificResources(businessModel: string): BusinessResources {
      ...
      freeResources: [
        {
          ...
          description: "Complete guide to ecommerce business terms and concepts",
          type: "free" as const
        }
      ],
      learningResources: [
  ...
  if (modelLower.includes('content') || modelLower.includes('creator') || modelLower.includes('youtube')) {
    return {
      freeResources: [
        {
